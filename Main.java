...
import Figuras.*;
import Academia_de_danza.Secretaria;
...
public class Main {
    ...
    secretaria.CrearDiagrama("tango","basico","3","miguel","lunes","10:30","321");
    secretaria.CrearDiagrama("tango","experto","1","santos","martes","12:30","43");
    secretaria.CrearAlumno("jorge","123432","32432231","123","321");
    secretaria.CrearAlumno("ricardo","123432","32432231","432","321");
    secretaria.CrearAlumno("rome","123432","32432231","654","321");
    secretaria.acistencia("jorge","123");
    secretaria.acistencia("jorge","123");
    secretaria.acistencia("jorge","123");
    System.out.printf(secretaria.Importemensual());
    System.out.printf(secretaria.Diciplina_mayor_ingreso());
    //ejercicio 9
    System.out.printf("\nEjercicio 9 \n ------------------------------------------\n");
